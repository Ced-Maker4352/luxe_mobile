...
class _AccessGrantedScreenState extends State<AccessGrantedScreen>
  ...
  void initState() {
    super.initState();
    _controller = AnimationController(duration: AppMotion.major, vsync: this);

    _scaleAnimation = Tween<double>(
      begin: 0.9,
      end: 1.0,
    ).animate(CurvedAnimation(parent: _controller, curve: AppMotion.cinematic));

    _fadeAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: _controller,
        curve: const Interval(0.2, 1.0, curve: AppMotion.cinematic),
      ),
    );
                ...
                builder: (context, child) {
                  return Opacity(
                    ...
                    child: Transform.translate(
                      offset: Offset(
                        0,
                        AppMotion.pageRise * (1 - _fadeAnimation.value),
                      ),
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.translate(
                      offset: Offset(0, 4 * (1 - _fadeAnimation.value)),
                      child: child,
                    );
                  },
                  child: Column(
